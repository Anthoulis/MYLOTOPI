(function () {
  ...
  window.MYLOTOPI_GUIDE_LOCALES.pl = {
  "ui": {
    "kicker": "Mylotopi QR Guide",
    "pageTitle": "Heritage Walk - Polish content pending",
    "intro": "Polish guide content is pending. This placeholder keeps the full 9-stop tour structure available until final translated text and narration are ready.",
  ...
  "spots": {
    "welcome": {
      ...
      "shortTitle": "Welcome",
      "shortText": "Polish content pending for Welcome / Introduction.",
      "imageAlt": "Image slot for Welcome / Introduction",
      "audio": {
        "path": "./assets/audio/pl/01-welcome.wav",
        "ready": true,
        "caption": "Silent Polish audio placeholder. Replace this file with final narration using the same filename."
      },
      "body": [
        "Polish translated content is pending for this stop."
      ]
    },
    "herb-garden": {
      "title": "Garden with Herbs",
      "shortTitle": "Herb Garden",
      "shortText": "Polish content pending for Garden with Herbs.",
      "imageAlt": "Image slot for Garden with Herbs",
      "audio": {
        "path": "./assets/audio/pl/02-herb-garden.wav",
        "ready": true,
        "caption": "Silent Polish audio placeholder. Replace this file with final narration using the same filename."
      },
      "body": [
    ...
    "windmill-first-floor": {
      ...
      "shortText": "Polish content pending for Windmill - First Floor.",
      "imageAlt": "Image slot for Windmill - First Floor",
      "audio": {
        "path": "./assets/audio/pl/03-windmill-first-floor.wav",
        "ready": true,
        "caption": "Silent Polish audio placeholder. Replace this file with final narration using the same filename."
      },
      "body": [
    ...
    "windmill-second-floor": {
      ...
      "shortText": "Polish content pending for Windmill - Second Floor.",
      "imageAlt": "Image slot for Windmill - Second Floor",
      "audio": {
        "path": "./assets/audio/pl/04-windmill-second-floor.wav",
        "ready": true,
        "caption": "Silent Polish audio placeholder. Replace this file with final narration using the same filename."
      },
      "body": [
    ...
    "windmill-third-floor": {
      ...
      "shortText": "Polish content pending for Windmill - Third Floor.",
      "imageAlt": "Image slot for Windmill - Third Floor",
      "audio": {
        "path": "./assets/audio/pl/05-windmill-third-floor.wav",
        "ready": true,
        "caption": "Silent Polish audio placeholder. Replace this file with final narration using the same filename."
      },
      "body": [
    ...
    "threshing-floor-donkeys": {
      ...
      "shortText": "Polish content pending for Threshing Floor & Donkeys.",
      "imageAlt": "Image slot for Threshing Floor & Donkeys",
      "audio": {
        "path": "./assets/audio/pl/06-threshing-floor-donkeys.wav",
        "ready": true,
        "caption": "Silent Polish audio placeholder. Replace this file with final narration using the same filename."
      },
      "body": [
    ...
    "cellar-italian-tunnel": {
      ...
      "shortText": "Polish content pending for Cellar / Italian Tunnel.",
      "imageAlt": "Image slot for Cellar / Italian Tunnel",
      "audio": {
        "path": "./assets/audio/pl/07-cellar-italian-tunnel.wav",
        "ready": true,
        "caption": "Silent Polish audio placeholder. Replace this file with final narration using the same filename."
      },
      "body": [
    ...
    "traditional-house": {
      ...
      "shortText": "Polish content pending for Traditional House.",
      "imageAlt": "Image slot for Traditional House",
      "audio": {
        "path": "./assets/audio/pl/08-traditional-house.wav",
        "ready": true,
        "caption": "Silent Polish audio placeholder. Replace this file with final narration using the same filename."
      },
      "body": [
    ...
    "bakery": {
      "title": "Bakery",
      "shortTitle": "Bakery",
      "shortText": "Polish content pending for Bakery.",
      "imageAlt": "Image slot for Bakery",
      "audio": {
        "path": "./assets/audio/pl/09-bakery.wav",
        "ready": true,
        "caption": "Silent Polish audio placeholder. Replace this file with final narration using the same filename."
      },
      "body": [
