(function () {
  ...
  window.MYLOTOPI_GUIDE_LOCALES.es = {
  "ui": {
    "kicker": "Mylotopi QR Guide",
    "pageTitle": "Heritage Walk - Spanish content pending",
    "intro": "Spanish guide text is pending. This placeholder keeps the full 9-stop tour structure available until final translated text is ready.",
    ...
    "audioPlaceholderNotice": "Spanish audio narration is available for this stop.",
  ...
  "spots": {
    "welcome": {
      ...
      "shortTitle": "Welcome",
      "shortText": "Spanish content pending for Welcome / Introduction.",
      "imageAlt": "Image slot for Welcome / Introduction",
      "audio": {
        "path": "./assets/audio/es/01-welcome.mp3",
        "ready": true
      },
      "body": [
        "Spanish translated content is pending for this stop."
      ]
    },
    "herb-garden": {
      "title": "Garden with Herbs",
      "shortTitle": "Herb Garden",
      "shortText": "Spanish content pending for Garden with Herbs.",
      "imageAlt": "Image slot for Garden with Herbs",
      "audio": {
        "path": "./assets/audio/es/02-herb-garden.mp3",
        "ready": true
      },
      "body": [
        "Spanish translated content is pending for this stop."
    ...
    "windmill-first-floor": {
      ...
      "shortText": "Spanish content pending for Windmill - First Floor.",
      "imageAlt": "Image slot for Windmill - First Floor",
      "audio": {
        "path": "./assets/audio/es/03-windmill-first-floor.mp3",
        "ready": true
      },
      "body": [
        "Spanish translated content is pending for this stop."
    ...
    "windmill-second-floor": {
      ...
      "shortText": "Spanish content pending for Windmill - Second Floor.",
      "imageAlt": "Image slot for Windmill - Second Floor",
      "audio": {
        "path": "./assets/audio/es/04-windmill-second-floor.mp3",
        "ready": true
      },
      "body": [
        "Spanish translated content is pending for this stop."
    ...
    "windmill-third-floor": {
      ...
      "shortText": "Spanish content pending for Windmill - Third Floor.",
      "imageAlt": "Image slot for Windmill - Third Floor",
      "audio": {
        "path": "./assets/audio/es/05-windmill-third-floor.mp3",
        "ready": true
      },
      "body": [
        "Spanish translated content is pending for this stop."
    ...
    "threshing-floor-donkeys": {
      ...
      "shortText": "Spanish content pending for Threshing Floor & Donkeys.",
      "imageAlt": "Image slot for Threshing Floor & Donkeys",
      "audio": {
        "path": "./assets/audio/es/06-threshing-floor-donkeys.mp3",
        "ready": true
      },
      "body": [
        "Spanish translated content is pending for this stop."
    ...
    "cellar-italian-tunnel": {
      ...
      "shortText": "Spanish content pending for Cellar / Italian Tunnel.",
      "imageAlt": "Image slot for Cellar / Italian Tunnel",
      "audio": {
        "path": "./assets/audio/es/07-cellar-italian-tunnel.mp3",
        "ready": true
      },
      "body": [
        "Spanish translated content is pending for this stop."
    ...
    "traditional-house": {
      ...
      "shortText": "Spanish content pending for Traditional House.",
      "imageAlt": "Image slot for Traditional House",
      "audio": {
        "path": "./assets/audio/es/08-traditional-house.mp3",
        "ready": true
      },
      "body": [
        "Spanish translated content is pending for this stop."
    ...
    "bakery": {
      "title": "Bakery",
      "shortTitle": "Bakery",
      "shortText": "Spanish content pending for Bakery.",
      "imageAlt": "Image slot for Bakery",
      "audio": {
        "path": "./assets/audio/es/09-bakery.mp3",
        "ready": true
      },
      "body": [
        "Spanish translated content is pending for this stop."
